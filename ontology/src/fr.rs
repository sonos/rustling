...
pub fn examples_numbers() -> Vec<duckling::train::Example<Dimension>> {
    ...
    example!(v, examples::check_integer(33), "33", "trente trois", "trente-trois", "trente 3");
    example!(v, examples::check_integer(100000), "100.000", "100000", "100K", "100k");
    example!(v, examples::check_integer(3000000), "3M", "3000K", "3000000", "3.000.000");
    example!(v, examples::check_integer(1200000), "1.200.000", "1200000", "1,2M", "1200K", ",0012G");
    example!(v, examples::check_integer(-1200000), "- 1.200.000", "-1200000", "moins 1200000", "-1,2M", "-1200K", "-,0012G");
    example!(v, examples::check_ordinal(1), "1er", "1ere", "le 1er");
    example!(v, examples::check_ordinal(3), "3ieme", "le 3ieme", "3eme", "3ème", "troisième", "troisieme");
    v
}
